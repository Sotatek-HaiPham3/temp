...
class BountyAPIController extends AppBaseController
{
    ...
    **/
    ...
    /**
    * @SWG\Post(
    *   path="/user/bounty/mark-complete",
    ...
    **/
    ...
    /**
    * @SWG\Post(
    *   path="/user/bounty/cancel-bounty",
    ...
    **/
    ...
    /**
    * @SWG\Get(
    *   path="/user/bounty/for-gamelancer",
