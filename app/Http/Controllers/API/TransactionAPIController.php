...
class TransactionAPIController extends AppBaseController
{
    ...
    /**
     * @SWG\Post(
     *   path="/payment/deposit-without-logged/paypal",
    ...
    /**
     * @SWG\Post(
     *   path="/payment/deposit-without-logged/stripe",
    ...
    /**
     * @SWG\Get(
     *   path="/payment/transactions/history",
