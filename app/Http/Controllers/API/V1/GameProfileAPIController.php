...
class GameProfileAPIController extends AppBaseController
{
    ...
    /**
    * @SWG\Get(
    *   path="/v1/game-profiles",
    *   summary="Get Game Profiles",
    *   tags={"V1.Game Profiles"},
    *   @SWG\Parameter(
    *       name="slug",
    ...
    **/
    ...
    /**
    * @SWG\Post(
    *   path="/v1/user/game-profile/create",
    ...
    **/
    ...
    /**
    * @SWG\Put(
    *   path="/v1/user/game-profile/update",
    ...
    **/
    ...
    /**
    * @SWG\Post(
    *   path="/v1/user/game-profile/create-media",
    *   summary="Update Game Profile",
    *   tags={"V1.Game Profiles"},
    *   security={
    *     {"passport": {}},
    ...
    **/
    ...
    /**
    * @SWG\Delete(
    *   path="/v1/user/game-profile/delete-media",
    ...
    **/
    ...
    /**
    * @SWG\Delete(
    *   path="/v1/user/game-profile/delete",
    *   summary="Delete Game Profile",
    *   tags={"V1.Game Profiles"},
    *   security={
    *     {"passport": {}},
    ...
    **/
    ...
    /**
    * @SWG\Get(
    *   path="/v1/game-profile/collection",
    ...
    **/
    ...
    /**
    * @SWG\Get(
    *   path="/v1/user/game-profile/existed",
