...
class SessionAPIController extends AppBaseController
{
    ...
    **/
    ...
    /**
    * @SWG\Post(
    *   path="/v1/user/session/check-book-another-gamelancer",
    ...
    **/
    ...
    /**
    * @SWG\Get(
    *   path="/v1/user/session/check-gamelancer-offline",
    ...
    **/
    ...
    /**
    * @SWG\Put(
    *   path="/v1/user/session/accept-booking",
    ...
    **/
    ...
    /**
    * @SWG\Put(
    *   path="/v1/user/session/resject-booking",
    ...
    **/
    ...
    /**
    * @SWG\Post(
    *   path="/v1/user/session/add-request",
    ...
    **/
    ...
    /**
    * @SWG\Put(
    *   path="/v1/user/session/accept-request",
    ...
    **/
    ...
    /**
    * @SWG\Put(
    *   path="/v1/user/session/reject-request",
    ...
    **/
    ...
    /**
     * @SWG\Get(
     *   path="/v1/user/session/booked-slots",
    ...
    /**
     * @SWG\Get(
     *   path="/v1/user/session/booked-slots-as-user",
    ...
    /**
     * @SWG\Get(
     *   path="/v1/user/session/playing-session",
    ...
    **/
    ...
    /**
    * @SWG\Put(
    *   path="/v1/user/session/cancel-booking",
    ...
    **/
    ...
    /**
    * @SWG\Put(
    *   path="/v1/user/session/mark-as-complete",
    ...
    **/
    ...
    /**
    * @SWG\Put(
    *   path="/v1/user/session/reject-mark-complete",
    ...
    **/
    ...
    /**
    * @SWG\Put(
    *   path="/v1/user/session/continue-session",
    ...
    **/
    ...
    /**
    * @SWG\Get(
    *   path="/v1/user/session/data-bubble",
