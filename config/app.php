...
return [
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\MattermostProvider::class,

        App\Providers\FileProcessorProvider::class,

        App\Providers\SystemNotificationProvider::class,

        App\Providers\AwsProvider::class,

        App\Providers\ContentApplicationProvider::class,
    ...
    */
    ...
    'aliases' => [
        ...
        'Aws' => App\Facades\AwsFacade::class,
        'ContentApp' => App\Facades\ContentApplicationFacade::class,
