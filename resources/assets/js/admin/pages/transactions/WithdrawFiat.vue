<template>
  <div class="withdraw_page boxCore">
    <div class="pending_transaction">
      <div class="filter_container clearfix">
        <span class="title_item">
          <span class="title_text">Pending Transactions</span>
        </span>
      ...
      <div class="datatable">
        <data-table :getData="getPendingTransactions" ref="pending_transaction"  :limit="10" :column="7" class="scroll">
          ...
          <th class="text-left" data-sort-field="users.email">Branch</th>
          ...
          <template slot="body" slot-scope="props">
            <tr>
              ...
              <td class="text-left">
                {{props.item.amount | abs | formatUsdAmount('0')}}
              </td>
              <td class="text-right">
    ...
    <div class="transaction_history">
      <div class="filter_container clearfix">
        <span class="title_item clearfix">
          <span class="title_text">History Transactions</span>
        </span>
        <span class="search_box">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      downloadExcel() {
        let url = '/admin/transactions/usd-withdraw/export?currency=usd&status=' + this.status;
