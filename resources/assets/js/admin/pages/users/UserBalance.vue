      ...
      <section class="clearfix">
        ...
        <div class="data_box">
          <data-table :getData="getData"
            ...
            <th class="col1 title_name" data-sort-field="email">Email</th>
            <th class="col2 title_name" data-sort-field="coin">Coin</th>
            <th class="col3 title_name" data-sort-field="bar">Bar</th>
            <th class="col4 title_name">Action</th>
            <template slot="body" slot-scope="props">
              <template v-if="rows[ props.index ].editable === false">
                <tr>
                  <td class="col1">
                    {{ rows[ props.index ].email }}
                  </td>
                  <td class="col2">
                    {{ rows[ props.index ].coin | formatCurrencyAmount('0', 2) }}
                  </td>
                  <td class="col3">
                    {{ rows[ props.index ].bar | formatCurrencyAmount('0', 2) }}
                  </td>
              ...
              <template v-else>
                <tr>
                  ...
                  <td class="col4 text-right">
                    <button type="button" class="btn btn_edit_user cancel" @click.stop="onClickCancel(props.index)">
    ...
    methods: {
      ...
      async onClickSubmit() {
        ...
        window.ConfirmationModal.show({
          type: 'confirm',
          title: this.$t('common.confirm_msg'),
