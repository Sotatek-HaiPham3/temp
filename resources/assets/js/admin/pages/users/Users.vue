<template>
  <div class="boxCore" id="user_information">
    ...
    <div class="datatable">
        <data-table :getData="getData" ref="datatable" :limit="10" :column="11" @DataTable:finish="onDatatableFinish" class="scroll">
          ...
          <template slot="body" slot-scope="props">
            <template v-if="rows[ props.index ].editable === false">
              <tr>
                ...
                <td class="cl2 text-left">
                  ...
                  <p v-if="props.item.phone_number">{{ props.item.phone_number }}</p>
                </td>
                ...
                <td class="cl6 text-right">
                  <button type="button" class="btn btn_save_user" @click="onClickedUpdate(props.index)">
            ...
            <template v-else>
              <tr>
                ...
                <td class="cl6 text-right">
                  <button type="button" class="btn btn_update_user" @click.stop="onClickCancel()">
