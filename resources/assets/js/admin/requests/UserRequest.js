...
export default class UserRequest extends BaseRequest {
  ...
  getUsernames(params) {
    let url = '/admin/api/usernames'
    return this.get(url, params)
  }

  getUserRestrictPricing(params) {
    let url = '/admin/api/user/restrict-pricings'
    return this.get(url, params)
  }

  createUserRestrictPricing(params) {
    let url = '/admin/api/user/restrict-pricings/create'
    return this.post(url, params)
  }

  updateUserRestrictPricing(params) {
    let url = '/admin/api/user/restrict-pricings/update'
    return this.put(url, params)
  }

  deleteUserRestrictPricing(params) {
    let url = '/admin/api/user/restrict-pricings/delete'
    return this.del(url, params)
  }
}
